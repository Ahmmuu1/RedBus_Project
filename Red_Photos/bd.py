...
# Navigation Menu with Highlight
web = option_menu(
    menu_title="🚌 OnlineBus",
    options=["Home", "📍 States and Routes"],
    icons=["house", "map-marker-alt"],  # Updated icons for better visuals
    menu_icon="menu-app",  # Icon for the menu
    default_index=1,  # Highlighting "📍 States and Routes" by default
    orientation="horizontal",
    styles={
        "container": {"padding": "0!important", "background-color": "#f9f9f9"},
        "icon": {"color": "#fa5d55", "font-size": "20px"},
        "nav-link": {
            "font-size": "18px",
            "text-align": "center",
            "margin": "0px",
        ...
        "nav-link-selected": {"background-color": "#fa5d55", "color": "white"},
    },
)
...
if web == "📍States and Routes":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = pymysql.connect(host="localhost", user="root", password="12345", database="RED_BUS_DETAILS")
